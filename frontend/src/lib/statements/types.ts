...
// ParsedStatement is what a statement parser hands to the import inbox: the
// batch to stage plus human-readable notes (what was read or skipped on
// purpose) and warnings (checks that failed and deserve a manual look).
