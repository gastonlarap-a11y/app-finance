...
// purchase is on a card whose cutoff day has already passed (date.Day > billingDay),
// it rolls to the next month. Pass billingDay <= 0 for non-card expenses (no roll).
